#!/bin/sh
# Polls until app.ini exists and the gitea CLI can actually talk to the
# (possibly still-migrating) database, then creates the first admin user
# once. Safe to run on every boot: `gitea admin user create` fails
